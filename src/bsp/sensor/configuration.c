...
BSP_Sensor_Config_t bsp_sensor_config_table[BSP_MAX_SENSOR_PORT]={
		...
		{false,false,0,0,0,0x0L,0x0L,0x0L,0x0L,0x0L,0x0L,0x0L,0x0L},
		{true,true,BSP_SPI_SENSOR,3,6,0x0L,0x0L,0x0L,0x0L,0x0L,0x0L,0x0L,0x0L},
		{false,false,0,0,0,0x0L,0x0L,0x0L,0x0L,0x0L,0x0L,0x0L,0x0L}
};
/*------------------------------------*/
void bsp_init_sensor_data();
void bsp_init_sensor_data()
{
	int port;
